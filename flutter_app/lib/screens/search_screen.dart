            ...
            children: [
              ...
              Expanded(
                child: StreamBuilder<QuerySnapshot>(
                  //every time there is a change in Firestor the screen will automatically update
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (!snapshot.hasData) {
                      //displays a loading circle until information arrives
                    ...
                    return Scrollbar(
                      ...
                      child: ListView.builder(
                        //displays the songs on the screen
                        controller: _scrollController,
