...
class SongTile extends StatelessWidget {
  ...
  static const List<Color> colorsList = [
    //different colors that will repeat themselves in the list
    Color(0xFFFFD54F),
    Color(0xFFFF6E6E),
    Color(0xFF4CAF50),
    Color(0xFF42A5F5),
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            const SizedBox(
              width: 16,
            ), //space so that the text does not stick to the square

            Expanded(
              //the text takes up all the space left in the line
              child: Column(
                crossAxisAlignment:
